...
# from sam.openfold.config import NUM_RES, NUM_EXTRA_SEQ, NUM_TEMPLATES, NUM_MSA_SEQ
from sam.openfold.np import residue_constants as rc
from sam.openfold.utils.rigid_utils import Rotation, Rigid
from sam.openfold.utils.geometry.rigid_matrix_vector import Rigid3Array
from sam.openfold.utils.geometry.rotation_matrix import Rot3Array
from sam.openfold.utils.geometry.vector import Vec3Array
from sam.openfold.utils.tensor_utils import (
    tree_map,
    tensor_tree_map,
    batched_gather,
)
...
def _make_pseudo_beta(protein, prefix=""):
...
@curry1
def make_pseudo_beta(*args, **kwargs):
    return _make_pseudo_beta(*args, **kwargs)
...
@curry1
def atom37_to_torsion_angles(*args, **kwargs):
    return _atom37_to_torsion_angles(*args, **kwargs)
